...
public class ProximitySensorActivity extends BaseActivity implements SensorEventListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sensorManager.registerListener(this, sensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY), SensorManager.SENSOR_STATUS_ACCURACY_HIGH);
    }
